...
//    USART1_Init(baudRate_Selection);     // 初始化串口1波特率
    ...
    ////            motor_speed = TMC5160_SPIReadInt(0x22, 0x00000000); // 读取实际电机运行中的速度
    ...
    //            motor_step = TMC5160_SPIReadInt(0x21, 0x00000000);

    //            TMC5160_SPIReadInt(0x39, 0x00000000);               //读取编码器的计数值，同样需要读二次 此处因为循环中
    //            encoder_step = TMC5160_SPIReadInt(0x39, 0x00000000);
