...
uint8_t ft5206_init(void)
{
    ...
    /* 使能时钟 */
    FT5206_RST_GPIO_CLK_ENABLE();                           /* 使能FT5206 RST引脚端口时钟 */
    FT5206_INT_GPIO_CLK_ENABLE();                           /* 使能FT5206 INT引脚端口时钟 */
    
    /* 配置FT5206 RST引脚 */
    gpio_init_struct.pin = FT5206_RST_GPIO_PIN;             /* FT5206 RST引脚 */
    ...
    GPIO_Config(FT5206_RST_GPIO_PORT, &gpio_init_struct);   /* 配置FT5206 RST引脚 */
    
    /* 配置FT5206 INT引脚 */
    gpio_init_struct.pin = FT5206_INT_GPIO_PIN;             /* FT5206 INT引脚 */
    gpio_init_struct.mode = GPIO_MODE_IN;                   /* 输入模式 */
    gpio_init_struct.pupd = GPIO_PUPD_UP;                   /* 上拉 */
    GPIO_Config(FT5206_INT_GPIO_PORT, &gpio_init_struct);   /* 配置FT5206 INT引脚 */
    
    ct_iic_init();                                          /* 初始化触摸屏IIC */
    
    /* 复位FT5206 */
    FT5206_RST(0);                                          /* 使能FT5206复位 */
    delay_ms(10);
    FT5206_RST(1);                                          /* 释放FT5206复位 */
    delay_ms(10);
